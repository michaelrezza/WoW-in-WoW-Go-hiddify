...
def load_template():
    ...
    if not os.path.exists(TEMPLATE_FILE):
        print("⚠️ Template file not found. Using empty structure...")
    ...
    try:
        ...
        print("❌ Error: Invalid template format.")
        return {"route": {}, "outbounds": []}

def update_config(template, ipv6, port):
    """Update the template with new IPv6 and port"""
...
def main():
    ...
    updated_config = update_config(template, ipv6, port)
